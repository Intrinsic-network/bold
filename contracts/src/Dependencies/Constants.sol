...
uint256 constant CCR_CBBTC = 150 * _1pct; // Same as WETH

uint256 constant MCR_WETH = 110 * _1pct;
uint256 constant MCR_SETH = 120 * _1pct;
uint256 constant MCR_CBBTC = 110 * _1pct; // Same as WETH

uint256 constant SCR_WETH = 110 * _1pct;
uint256 constant SCR_SETH = 120 * _1pct;
uint256 constant SCR_CBBTC = 110 * _1pct; // Same as WETH
...
uint256 constant LIQUIDATION_PENALTY_SP_CBBTC = 5 * _1pct; // Same as WETH
...
uint256 constant LIQUIDATION_PENALTY_REDISTRIBUTION_CBBTC = 10 * _1pct; // Same as WETH
